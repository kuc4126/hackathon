...
<html>
    <head>
        ...
        <title>SOSEGE</title>
        <link rel="stylesheet" href="write_style.css?v=1.2">
    ...
    <body>
        <header>
            ...
            <div class="hambuger-bar">
                ...
                <ul class="hambuger-bar-menu">
                    ...
                    <a href="write.php"><li class="nanum-gothic-regular">글쓰기</li></a>
        ...
        <div class="main-footer">
            <main>
                <div class="container">
                    ...
                    <div class="h1-box"><h1 class="black-han-sans-regular">글쓰기</h1></div>
                    <div class="section">
                        <label for="title" class="nanum-gothic-regular label">제목</label>
                        <input type="text" id="title" name="title" class="write-input nanum-gothic-regular iwanttogohome" placeholder="제목을 입력해주세요">
                    </div>
                    <div class="section">
                        <label for="price" class="nanum-gothic-regular label">가격</label>
                        <input type="text" id="price" name="price" class="write-input nanum-gothic-regular iwanttogohome" placeholder="가격을 입력해주세요">
                    </div>
                    <div class="textarea-section">
                        <label for="content" class="nanum-gothic-regular label">내용입력</label>
                        <textarea id="content" name="content" placeholder="내용을 입력해주세요" class="nanum-gothic-regular iwanttogohome"></textarea>
                    </div>
                    <div class="margin50"></div>
                    <div class="image-section" id="imageSection"></div>
                    <div class="margin50"></div>
                    <div class="hashtag-section">
                        <div class="hashtag-label-box"><label for="hashtag" class="nanum-gothic-regular label">해시태그</label></div>
                        <div class="hashtag-input-container">
                            <input type="text" id="hashtag" placeholder="해시태그를 입력해주세요" class="write-input-hashtag nanum-pen-script-regular iwanttogohome" maxlength="10">
                            <div class="hashtag-list" id="hashtagList"></div>
                        </div>
                    </div>
                    <div class="sponsor-section">
                        <p class="nanum-gothic-regular label">후원여부</p>
                        <input type="checkbox" id="sponsor">
                        <label for="sponsor" class="sponsor-label"></label>
                    </div>
                    <div class="margin50"></div>
                    <div class="upload-section">
                        <button class="nanum-gothic-regular">업로드</button>
                    </div>
                    <div class="margin"></div>
                </div>

                <div id="customAlert">
                    <p id="alertMessage" class="nanum-gothic-regular">중복된 이미지는 첨부할 수 없습니다</p>
        ...
        <script src="write_script.js?v=1.2"></script>
    </body>
</html>