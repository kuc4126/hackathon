...
<head>
  ...
  <title>SOSEGE</title>
  <link rel="stylesheet" href="detail_style2.css?v=1.4">
...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="slider-wrapper" id="sliderWrapper">
                <div id="gallery" class="image-slider">
                </div>
        ...
        <div class="product-info">
            <div class="title-wrapper">
                <img src="user.png" alt="프로필 이미지" class="profile-image-small" />
                <p id="title" class="nanum-gothic-regular product-name">상품 이름</p>
            </div>
            <div class="id-cover">
                <p id="author" class="id-id nanum-gothic-regular">아이디</p>
                <img src="tick-mark.png" alt="기업 인증 마크" class="certified-icon" />
            </div>
            <p id="price" class="price nanum-pen-script-regular">₩가격</p>
            <div class="location-cover">
                <p id="created_at" class="date nanum-gothic-regular">날짜</p>
            </div>
            <div class="divider">
            </div>
            <p id="content" class="nanum-gothic-regular product-description">어쩌고 저쩌고</p>
        </div>
        
        <?php if (isset($_SESSION['user_id'])): ?>
            <button id="matchBtn" class="like-button">매칭하기</button>
        <?php else: ?>
            <a href="../sign_up/signUp.php" class="like-button-a">매칭하기</a>
        <?php endif; ?>
    </main>
    <footer>
      <div>
  ...
  <script src="detail_script.js?v=1.4"></script>
</body>
</html>