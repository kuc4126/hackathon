...
<html lang="ko">
    <head>
        ...
        <title>SOSEGE</title>
        <link rel="stylesheet" href="finish_style.css?v=1.2">
    ...
    <body>
        ...
        <div class="main-footer">
            <main class="container">
                <div>
                    <div class="matching-message margin-top-150 black-han-sans-regular">
                        매칭 완료
                    </div>
                    <div class="matching-icon margin-top-50">
                        <img src="images/80.png" alt="매칭 완료 아이콘">
                        
                    </div>
                    <div class="matching-content margin-top-50 noto-sans-kr-300">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur, nisi in dignissim commodo, urna ligula posuere sem, id tempus ex enim ac turpis. Aliquam erat volutpat. Suspendisse non elit.
                    </div>
                    <div class="confirm-button-area margin-top-80">
                        <a href="#" class="confirm-button">확인</a>
                    </div>
                </div>
            </main>
            <footer>
        ...
        <script src="finish_script.js?v=1.2"></script>
    </body>
</html>